...
protected:
	...
	float spacing[3]; // the space (distance) between two neighboring points
	float origin[3]; // the origin - this is equivalent to the miminum of xRange,yRange,zRange values
